    ...
    override fun onStart() {
        ...
        private fun initMap(adapter: ExtraEntryAdapter?) {
            ...
            for (i in 0 until 100) {
                ...
                var fail: Int? = null
                when (fail1) {
                    1 -> fail = resources.getIdentifier(
                        "@drawable/z_" + zz,
                        "drawable",
                        requireActivity().packageName
                    )
                    2 -> fail = resources.getIdentifier(
                        "@drawable/b_" + zz,
                        "drawable",
                        requireActivity().packageName
                    )
                    3 -> fail = resources.getIdentifier(
                        "@drawable/e_" + zz,
                        "drawable",
                        requireActivity().packageName
                    )
                    4 -> fail = resources.getIdentifier(
                        "@drawable/h_" + zz,
                        "drawable",
                        requireActivity().packageName
                    )
                ...
                when (succeed1) {
                    1 -> succeed = resources.getIdentifier(
                        "@drawable/t_" + zz,
                        "drawable",
                        requireActivity().packageName
                    )
                    ...
                    else -> succeed = resources.getIdentifier(
                        "@drawable/t_" + zz,
                        "drawable",
                        requireActivity().packageName
                    )
        ...
        private fun checkAround(x: Int, y: Int, list: ArrayList<ExtraEntry>): Int {
            var count = 0
